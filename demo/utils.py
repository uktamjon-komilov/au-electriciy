...
def parse_datetime(value: str, line: int = None) -> datetime:
    ...
    try:
        ...
        raise CommandError("Date time data '{}' (in line {}) does not match format '{}'".format(value, line, format_str))
    ...
    with open(path, "r") as file:
        ...
        for index, line in enumerate(file.readlines()):
            ...
            try:
                ...
                raise CommandError("There is error while extracting data from CSV (line {})".format(line_number))
    return data
